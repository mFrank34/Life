...
namespace app::window
{
    ...
    void Interface::on_speed(SimSpeed speed)
    {
        ...
        switch (speed)
        {
        case SimSpeed::X1: simulation.set_speed(1.0f);
            break;
        case SimSpeed::X2: simulation.set_speed(2.0f);
            break;
        case SimSpeed::X4: simulation.set_speed(4.0f);
            break;
        case SimSpeed::X8: simulation.set_speed(8.0f);
            break;
        }
